...
def main():
  ...
  parser.add_argument(
        ...
        required=True,
        nargs='+',
        help="paths to config yaml containing info about experiment",
  )
  parser.add_argument(
        "--gpu_num",
        type=int,
  ...
  config_files = []
  for config_folder in args.config_folders:
    config_files += glob.glob(os.path.join(config_folder, file_template))
