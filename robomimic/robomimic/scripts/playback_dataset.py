...
# python playback_dataset.py --dataset /vision/shuhan/projects/imitation/mix_demo/datasets/square/mh/image.hdf5 --use-actions --render_image_names agentview --video_path /vision/shuhan/projects/imitation/demo_videos/test.mp4 --n 5