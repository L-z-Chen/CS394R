...
class BaseConfig(Config):
    ...
    def curriculm_config(self):
        self.curriculm.name = "demo_quality"

        # demo quality curriculm setting
        self.curriculm.demo_quality.milestones = [500]
        self.curriculm.demo_quality.mask_names = [['worse'], ['better']]
        self.curriculm.demo_quality.sample_weights = [1.0, 0.0]

        # loss filter curriculum setting
        self.curriculm.loss_filter.filter_highest = False
        self.curriculm.loss_filter.filter_value = ['1sigma']
        self.curriculm.loss_filter.bins = [10]
        self.curriculm.loss_filter.milestone = [0]
        self.curriculm.loss_filter.demo_stages = 1


    def pretrain_config(self):
        self.pretrain.enable = False

        # pretrain the model with demo from another dataset
        self.pretrain.data = None
        self.pretrain.num_epoches = 500
    ...
    def experiment_config(self):
        ...
        ## variance config ##
        self.experiment.action_variance = False
        self.experiment.action_variance_keys = ['worse', 'better']
        ...
        ## use pretrain model config ##
        self.experiment.pretrain.path = None
        self.experiment.pretrain.validate_only = False
