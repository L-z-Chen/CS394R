...
class SequenceDataset(torch.utils.data.Dataset):
    ...
    def load_demo_info(self, filter_by_attribute=None, demos=None):
        ...
        # get demo mask names
        self._demo_mask_names = {}
        for demo in self.demos:
            self._demo_mask_names[demo] = []
            for mask_name in self.hdf5_file['mask'].keys():
                if demo.encode("utf-8") in self.hdf5_file['mask'][mask_name]:
                    self._demo_mask_names[demo].append(mask_name)

        self.n_demos = len(self.demos)
        #print('dataset num demos', self.n_demos)
        ...
        for ep in self.demos:
            ...
            #print('current total number seq', self.total_num_sequences)
    ...
    def get_item(self, index):
        ...
        meta['mask_names'] = self._demo_mask_names[demo_id]
